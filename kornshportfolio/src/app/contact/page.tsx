      ...
      <section className="max-w-2xl mx-auto px-4 rounded-lg shadow-md my-8" style={{ background: 'none' }}>
        ...
        <div className="mt-8 flex flex-col items-center gap-2 text-gray-600">
          <a
            ...
            className="flex items-center gap-2 transition-colors duration-200 hover:text-blue-600 hover:bg-blue-50 px-2 py-1 rounded"
          ...
          <a
            href="https://www.linkedin.com/in/ujju16/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 transition-colors duration-200 hover:text-blue-700 hover:bg-blue-100 px-2 py-1 rounded"
            style={{ fontWeight: 500 }}
          >
