...
export default function SkillsPage() {
	return (
		<main className="min-h-screen pt-24 pb-12">
			...
			<Navbar />
			<section
				className="max-w-4xl mx-auto px-4 rounded-lg shadow-md my-8"
				style={{ background: 'none' }}
			>
				<h1 className="text-3xl font-bold mb-8 text-center section-title">
					Compétences
				</h1>
				<div className="mb-8">
					<h2
						className="text-xl font-semibold mb-4 section-title"
